...
class PETRv2DNHead_version1(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PETRv2DNHead_version1):
        ...
        super(PETRv2DNHead_version1, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def prepare_for_dn(self, batch_size, reference_points, img_metas, objectlist_bbox):
        if self.training:            
            ...
            #targets_ = [torch.cat((img_meta['gt_bboxes_3d']._data.gravity_center, img_meta['gt_bboxes_3d']._data.tensor[:, 3:]),dim=1) for img_meta in img_metas ]
            #labels_ = [img_meta['gt_labels_3d']._data for img_meta in img_metas ]
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is PETRv2DNHead_version1:
            convert_dict = {
