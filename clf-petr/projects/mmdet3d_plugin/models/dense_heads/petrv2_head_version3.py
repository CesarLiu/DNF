...
class PETRv2Head_version3(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PETRv2Head_version3):
        ...
        super(PETRv2Head_version3, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is PETRv2Head_version3:
            convert_dict = {
        ...
        if training_model:
            ...
            for img_id in range(batch_size):
                if objectlist_bbox[img_id][0, 0, 0] == 1e-5:
                    objectlist_masks[img_id, :, :img_h, :img_w] = 0
                    continue
                for cam_id in range(num_cams):
                    img_h, img_w, _ = img_metas[img_id]['img_shape'][cam_id]                 
