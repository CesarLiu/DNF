...
# info_prefix = 'val'
# info_prefix = 'test'
data_root = "/home/jguo/PETR/PETR/data/nuscenes/"
...
info_path = os.path.join(data_root,'mmdet3d_nuscenes_30f_infos_formypetr_{}.pkl'.format(info_prefix))
key_infos = pickle.load(open(os.path.join(data_root,'nuscenes_try1_infos_{}.pkl'.format(info_prefix)), 'rb'))
if info_prefix == 'test':
