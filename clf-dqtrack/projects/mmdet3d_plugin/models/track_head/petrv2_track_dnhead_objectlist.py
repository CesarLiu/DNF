...
class PETRv2TrackDNHead_objectlist(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is PETRv2TrackDNHead_objectlist):
        ...
        super(PETRv2TrackDNHead_objectlist, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def prepare_for_dn(self, batch_size,img_metas, reference_points,  objectlist_bbox):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is PETRv2TrackDNHead_objectlist:
            convert_dict = {
    ...
    def forward(self, mlvl_feats, img_metas, objectlist_bbox, objectlist_bbox_corner):
        ...
        reference_points, attn_mask, mask_dict = self.prepare_for_dn(batch_size, img_metas,reference_points, objectlist_bbox)
