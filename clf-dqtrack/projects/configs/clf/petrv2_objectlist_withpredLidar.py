...
model = dict(
    ...
    img_neck=dict(
        ...
        num_outs=2),
    pts_bbox_head=dict(
        type='PETRv2TrackDNHead_objectlist',
        num_classes=10,
        in_channels=256,
        num_query=900,
        LID=True,
...
dataset_type = 'NuScenesDatasetPETRTrack_withpred'
...
train_pipeline_post = [
    ...
    dict(type='CreateObjectListWithNoise_forobjectlist_DQTrack',with_object_list=True, offset_scale=2.0, change_prob=0.3, drop_prob=0.2),
...
data = dict(
    ...
    val=dict(type=dataset_type, pipeline=test_pipeline, pipeline_post=test_pipeline_post, 
             ...
             ann_file=info_root + 'mmdet3d_nuscenes_30f_infos_val_w_obj.pkl', 
...
load_from='ckpts/pretrain/update_to_server/dn_try2_1080.pth' 
