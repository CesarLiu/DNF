...
from projects.visualization import NuscenesTrackingBox as TrackingBox
...
def parse_args():
    ...
    parser.add_argument('--data_infos_path', type=str, default='/home/jguo/DQTrack/mmdetection3d/data/infos/mmdet3d_nuscenes_30f_infos_val.pkl')
